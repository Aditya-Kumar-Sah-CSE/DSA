...
class Solution {
public:
TreeNode* deleteHelper(TreeNode* root , unordered_set<int> &st ,TreeNode* &result){

    if(root == NULL) return NULL;

    root->left = deleteHelper(root->left,st,TreeNode* &result);
    root->right = deleteHelper(root,st,TreeNode* &result);
